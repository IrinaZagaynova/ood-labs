...
void DialogWithUser()
{
	...
	{
		cout << "1 - Black, 2 - Green, 3 - Hibiscus, 4 - Chamomile\n";
		int teaSortChoice;
		cin >> teaSortChoice;
		switch (teaSortChoice)
		{
		case (1):
			beverage = make_unique<CTea>(CTea::Sort::Black);
			break;
		case (2):
			beverage = make_unique<CTea>(CTea::Sort::Green);
			break;
		case (3):
			beverage = make_unique<CTea>(CTea::Sort::Hibiscus);
			break;
		case (4):
